...
public class Sprite {
	...
	public static Sprite player_dead = new Sprite(DEFAULT_SIZE, 8, 9, SpriteSheet.tiles, 14, 16);
	...
	public static Sprite ovape_invi = new Sprite(DEFAULT_SIZE, 6, 9, SpriteSheet.tiles, 16, 16);
